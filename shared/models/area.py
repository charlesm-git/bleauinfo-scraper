...
class Area(Base):
    ...
    # Relationship
    region: Mapped["shared.models.region.Region"] = relationship(
        "Region", back_populates="areas"
    )
    boulders: Mapped[Optional[List["shared.models.boulder.Boulder"]]] = (
        relationship(back_populates="area")
    )
